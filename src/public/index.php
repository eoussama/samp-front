					...
					<div class="ui segment">
						<div class="ui grid">
							<div id="fellas" class="three wide column">
								<img src="<?php echo pathfy('img', 'figures/fellas.png', true) ?>" alt="Who we are image.">
							</div>
				...
				<section class="eleven wide column">
					<div id="gallery" class="ui segment">
						...
						<div id="gallery-carousel">
							<img src="<?php echo pathfy('img', 'gallery/1.jpg', true) ?>" alt="A cop arresting a robber.">
							<img src="<?php echo pathfy('img', 'gallery/2.jpg', true) ?>" alt="A water tank knocking down robbers.">
							<img src="<?php echo pathfy('img', 'gallery/3.jpg', true) ?>" alt="Tram highjack.">
							<img src="<?php echo pathfy('img', 'gallery/4.jpg', true) ?>" alt="Parachute dive.">
							<img src="<?php echo pathfy('img', 'gallery/5.jpg', true) ?>" alt="Helicopter patrol.">
							<img src="<?php echo pathfy('img', 'gallery/6.jpg', true) ?>" alt="Gas station confrontation.">
							<img src="<?php echo pathfy('img', 'gallery/7.jpg', true) ?>" alt="Las Venturas hot pursuit.">
							<img src="<?php echo pathfy('img', 'gallery/8.jpg', true) ?>" alt="Police trail.">
							<img src="<?php echo pathfy('img', 'gallery/9.jpg', true) ?>" alt="Sneak attack.">
						</div>
					</div>
				</section>
