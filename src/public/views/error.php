...
<head>
	...
	<!-- The main stylesheet. -->
	<link rel="stylesheet" href="<?php echo pathfy('css', 'error/error.css', true, true); ?>">
...
<body class="<?php echo $config['website']['darkMode'] ? "dark" : "";  ?>">
	<main class="ui container">
		...
		<div class="content-wrapper">
			...
			<div class="ui large buttons">
				<a id="home-btn" href="./../index.php" class="ui <?php echo $inverted; ?> button">Home</a>
				<div class="or"></div>
	...
	<!-- The main script -->
	<script src="<?php echo pathfy('js', 'error/error.js', true, true); ?>"></script>
</body>
