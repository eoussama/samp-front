...
class Database
{
	 ...
	 * @param string $port: The database's port.
	...
	public function connect()
	{
		...
		try {
			$this->conn = new PDO("mysql:host=$this->db_host;port=$this->db_port;dbname=$this->db_name", $this->db_username, $this->db_password);
